...
export const moodSongs: Record<Exclude<Mood, 'recommended'>, Song[]> = {
  happy: [
    ...
    { title: "Nagada Sang Dhol", artist: "Shreya Ghoshal", youtubeUrl: "https://www.youtube.com/watch?v=wMZ8J8JKjIE", language: "Hindi" },
  ...
  sad: [
    ...
    { title: "Kinna Sona", artist: "Marjaavaan", youtubeUrl: "https://www.youtube.com/watch?v=LPHaFi0KTl0", language: "Punjabi" },
  ...
  energetic: [
    ...
    { title: "Patola", artist: "Blackmail", youtubeUrl: "https://www.youtube.com/watch?v=1Jzc4g4S2eo", language: "Punjabi" },
